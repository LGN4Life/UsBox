...
missing_flag = exist(data.Parameters.FileNames.Spike2,'file');
if missing_flag==0
    
    data.Parameters.FileNames.Spike2 = [data.Parameters.FileNames.Spike2 'x'];
    missing_flag = exist(data.Parameters.FileNames.Spike2,'file');
   
end
file_name = {data.Parameters.FileNames.Spike2};
if missing_flag~=0
