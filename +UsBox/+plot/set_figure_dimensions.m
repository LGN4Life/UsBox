...
top_edge = fig_size(2)-offset(1);
vertical_spacing = gap_size(2)+draw_size(2);
bottom_edge = top_edge -vertical_spacing*(num_sp(1)-1);
...
bottom_edge = top_edge:-vertical_spacing:bottom_edge;
figure(h)
sub_plot_num = 0;
